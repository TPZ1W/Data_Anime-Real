...
from service.chart_service import show_chart_rating_by_type, show_null_value_chart, show_chart_distribute_episodes, \
...
class MainGUI:
    ...
    def __init__(self):         
        ...
        self.list_entry_variable = [                        # danh sach bien nhap du lieu
    ...
    def create_frame_bottom(self):
        ...
        # Tạo danh sách các nút chức năng
        list_object_button = [
        ...
        # Duyệt qua danh sách các nút để tạo giao diện nút
    ...
    def scaled_data(self):
        df_scale = self.standard_scaler_service.scale(self.data_clean_service.clean_data(self.csv_helper.get_data()))
         # Làm sạch dữ liệu và chuẩn hóa nó
        ...
        # Tạo biểu đồ thể hiện dữ liệu chuẩn hóa
    ...
    def data_visualize(self):
        ...
        def show_chart_average_rating_by_type():
            fig = show_chart_rating_by_type(self.csv_helper.get_data())
            draw_chart(fig, "Đánh giá trung bình theo loại anime (average_rating_by_type)")
        ...
        options = [
            ...
            {"text": "Đánh giá trung bình theo loại anime (average_rating_by_type)", "bg": "light blue",
             "command": show_chart_average_rating_by_type},
